...
class MainTest(unittest.TestCase):
    def test_svrg_synthetic(self):
        return
        dir_path = os.path.dirname(os.path.realpath(__file__))
        n_words = 10
        timestamp = str(time.time())
        output_filename = "tmp_svrg_embeddings.txt_" + timestamp
    ...
    def test_svrg_real(self):
        return
        dir_path = os.path.dirname(os.path.realpath(__file__))
        n_words = 524
        timestamp = str(time.time())
        output_filename1 = "tmp_svrg_embeddings_1.txt_" + timestamp
        ...
        output_filename2 = "tmp_svrg_embeddings_2.txt_" + timestamp
